...
class SuppliersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create supplier" do
    assert_difference('Supplier.count') do
      post suppliers_url, params: { supplier: { first_name: @supplier.first_name, last_name: @supplier.last_name } }
    end
  ...
  test "should update supplier" do
    patch supplier_url(@supplier), params: { supplier: { first_name: @supplier.first_name, last_name: @supplier.last_name } }
